      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {foundationForums.map((forum) => (
          <button
            ...
            className="text-left bg-white/90 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all group flex flex-col"
          >
