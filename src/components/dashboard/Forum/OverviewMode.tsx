// src/components/forums/overview/OverviewMode.tsx
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-4">
            {paginatedTopics.topics.map((topic: any) => {
              const forum = [
                ...globalForums,
                ...companies.flatMap((c: any) => c.forums),
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {paginatedTopics.totalPages > 5 && (
                      <>
                        ...
                        <button
                          onClick={() =>
                            setCurrentPage(paginatedTopics.totalPages)
                          }
                          className={`w-8 h-8 rounded-lg transition-colors ${
        ...
        <div className="space-y-6">
          ...
          {userCompany && (
            <div>
              ...
              <div className="space-y-3">
                <button
                  onClick={() => handleCompanySelect(userCompany.id)}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-lg flex items-center justify-center text-white text-xs font-bold bg-gradient-to-br from-purple-600 to-indigo-600">
                        {userCompany.name.substring(0, 2).toUpperCase()}
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-500">
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {userCompany.forums.reduce(
                          (sum, f) => sum + f.topicCount,
                          0
                        )}{" "}
                        topics
                      </span>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{userCompany.memberCount} members</span>
                    </div>
                  </div>
                </button>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {globalForums.slice(0, 5).map((forum) => (
                <button
                  key={forum.id}
