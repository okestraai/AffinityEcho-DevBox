...
import { X, Target, Star, MessageCircle, Calendar, Award } from 'lucide-react';
...
export function MentorshipModal({ isOpen, onClose }: Props) {
      ...
      <div className="bg-white w-full rounded-t-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900">Mentor Matches</h3>
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] p-4">
          <div className="space-y-4">
            {mentorMatches.map((mentor) => (
              <div key={mentor.id} className="bg-white rounded-xl p-4 border-2 border-gray-200 hover:border-blue-300 transition-all">
                ...
                <p className="text-sm text-gray-700 mb-3 leading-relaxed">{mentor.bio}</p>
                ...
                <div className="flex items-center justify-between text-xs text-gray-500 mb-4">
                  ...
                  <div className="flex gap-2">
                    {mentor.languages.map((lang) => (
                      <span key={lang} className="bg-gray-100 px-2 py-1 rounded-full">{lang}</span>
                    ))}
                  </div>
                </div>
          ...
          <div className="mt-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-4 border border-purple-200">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Become a Mentor</h3>
              <p className="text-sm text-gray-600 mb-3">
                Help others in your field while building meaningful professional relationships.
              </p>
              <button
                onClick={onClose}
